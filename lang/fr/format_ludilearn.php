...
$string['ludilearn:view'] = 'Voir le cours gamifié';
...
$string['settingsname'] = 'Personnalisation du format de cours LudiLearn';
...
$string['tools'] = 'Outils';
$string['settings:report'] = 'Rapport et individualisation des éléments de jeu';
